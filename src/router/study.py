...
@router.post('/study/create_db/', tags=['admin'])
...
@router.put('/study/', response_model=StudySchema, tags=['admin'])
...
@router.get('/study/', response_model=List[StudySchema], tags=['study'])
...
@router.get('/study/{study_id}', response_model=StudySchema, tags=['study'])
...
@router.put('/study/{study_id}/step/', response_model=StepSchema, tags=['admin'])
...
@router.get('/study/{study_id}/step/', response_model=List[StepSchema], tags=['study'])
...
@router.get('/study/{study_id}/step/{step_id}', response_model=StepSchema, tags=['study'])
...
@router.get('/study/{study_id}/step/first/', response_model=StepSchema, tags=['study'])
...
@router.get('/study/{study_id}/step/{step_id}/next', response_model=StepSchema, tags=['study'])
...
@router.delete('/study/{study_id}/step/{step_id}', response_model=StepSchema, tags=['admin'])
...
@router.put('/study/{study_id}/step/{step_id}/page/', response_model=PageSchema, tags=['admin'])
...
@router.get('/study/{study_id}/step/{step_id}/page/', response_model=List[PageSchema], tags=['study'])
...
@router.get('/study/{study_id}/step/{step_id}/page/{page_id}', response_model=PageSchema, tags=['study'])
...
@router.get('/study/{study_id}/step/{step_id}/page/first/', response_model=PageSchema, tags=['study'])
...
@router.get('/study/{study_id}/step/{step_id}/page/{page_id}/next', response_model=PageSchema, tags=['study'])
...
@router.delete('/study/{study_id}/step/{step_id}/page/{page_id}', response_model=PageSchema, tags=['admin'])
...
@router.put('/study/{study_id}/step/{step_id}/page/{page_id}/question/', response_model=QuestionSchema, tags=['admin'])
...
@router.get('/study/{study_id}/step/{step_id}/page/{page_id}/question/', response_model=List[QuestionSchema], tags=['study'])
...
@router.delete('/study/{study_id}/step/{step_id}/page/{page_id}/question/{question_id}', response_model=QuestionSchema, tags=['admin'])
