...
async def recommend_for_study_condition(
    ...
    # rated_item_ids = [reqitem.item_id for reqitem in payload]
    ...
    # TODO: add a rectype to study_conditions table
    cache_key = (
        participant.id,
    ...
    # if not condition or study_condition.study_id != study.id:
