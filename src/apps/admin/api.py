...
from apps.admin.routers import construct_items as items_admin
from apps.admin.routers import construct_scales as scales_admin
from apps.admin.routers import movies as movie_admin
from apps.admin.routers import scale_levels as level_admin
from apps.admin.routers import step_pages as page_admin
from apps.admin.routers import studies as study_admin
from apps.admin.routers import study_conditions as condition_admin
from apps.admin.routers import study_steps as step_admin
from apps.admin.routers import survey_constructs as construct_admin
