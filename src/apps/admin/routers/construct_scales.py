...
from data.services import ConstructScaleService, ScaleLevelService
from data.services.survey_dependencies import get_construct_scale_service as scales_service
from data.services.survey_dependencies import get_scale_level_service as level_service
